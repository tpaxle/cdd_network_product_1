...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 10.0.0.121/24 | 10.0.0.1 |
...
| --------- | --------------- | ------------ | --------- |
| AZ2_BL25G | Vlan4094 | 10.129.2.29 | Port-Channel19 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet19 | MLAG_PEER_BLEAF202_Ethernet19 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 19 |
| Ethernet20 | MLAG_PEER_BLEAF202_Ethernet20 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 19 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_BLEAF101_Ethernet1 | routed | - | 10.214.6.1/31 | default | 1500 | false | - | - |
| Ethernet2 | P2P_LINK_TO_BLEAF102_Ethernet2 | routed | - | 10.214.6.7/31 | default | 1500 | false | - | - |
| Ethernet17 | P2P_LINK_TO_SPINE201_Ethernet5 | routed | - | 10.129.4.57/31 | default | 1500 | false | - | - |
| Ethernet18 | P2P_LINK_TO_SPINE202_Ethernet5 | routed | - | 10.129.4.59/31 | default | 1500 | false | - | - |
...
!
interface Ethernet1
   description P2P_LINK_TO_BLEAF101_Ethernet1
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet2
   description P2P_LINK_TO_BLEAF102_Ethernet2
   no shutdown
   mtu 1500
   no switchport
   ip address 10.214.6.7/31
   ip ospf network point-to-point
   ip ospf area 0.0.0.0
!
interface Ethernet17
   description P2P_LINK_TO_SPINE201_Ethernet5
   no shutdown
   mtu 1500
   no switchport
   ip address 10.129.4.57/31
   ip ospf network point-to-point
   ip ospf area 0.0.0.0
   link tracking group LT_GROUP1 upstream
!
interface Ethernet18
   description P2P_LINK_TO_SPINE202_Ethernet5
   no shutdown
   mtu 1500
   no switchport
   ip address 10.129.4.59/31
   ip ospf network point-to-point
   ip ospf area 0.0.0.0
   link tracking group LT_GROUP1 upstream
!
interface Ethernet19
   description MLAG_PEER_BLEAF202_Ethernet19
   no shutdown
   channel-group 19 mode active
!
interface Ethernet20
   description MLAG_PEER_BLEAF202_Ethernet20
   no shutdown
   channel-group 19 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel19 | MLAG_PEER_BLEAF202_Po19 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel19
   description MLAG_PEER_BLEAF202_Po19
   no shutdown
   switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.129.0.15/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 10.129.1.15/32 |
| Loopback2 | VRF-NONPRO_VTEP_DIAGNOSTICS | VRF-NONPRO | 192.168.7.79/32 |
...
interface Loopback0
   ...
   no shutdown
   ip address 10.129.0.15/32
   ip ospf area 0.0.0.0
!
interface Loopback1
   description VTEP_VXLAN_Tunnel_Source
   no shutdown
   ip address 10.129.1.15/32
   ip ospf area 0.0.0.0
!
interface Loopback2
...
| Vlan3999 |  VRF-NONPRO  |  10.129.3.28/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  10.129.3.28/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  10.129.2.28/31  |  -  |  -  |  -  |  -  |  -  |
...
| ---------- | --------- | ------------------------- | -------------------- | --- | ------- | ----------------------------- | ---------------------------- | ----------------------------- | ------------- | --------------------- | ------------------ |
| 100 | 10.129.0.15 | enabled | Ethernet17 <br> Ethernet18 <br> Vlan4093 <br> Ethernet1 <br> Ethernet2 <br> | disabled | 12000 | disabled | disabled | - | - | - | - |
...
| -------------- | --------------------- |
| VRF-NONPRO | 192.168.7.79 |

## Virtual Source NAT Configuration

```eos
!
ip address virtual source-nat vrf VRF-NONPRO address 192.168.7.79
```
