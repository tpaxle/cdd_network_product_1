...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 10.0.0.131/24 | 10.0.0.1 |
...
| --------- | --------------- | ------------ | --------- |
| AZ2_CL1_2 | Vlan4094 | 10.129.2.1 | Port-Channel19 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 |  VPC201_VPC201-nic0 | access | 17 | - | - | - |
| Ethernet19 | MLAG_PEER_LEAFA202_Ethernet19 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 19 |
| Ethernet20 | MLAG_PEER_LEAFA202_Ethernet20 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 19 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet17 | P2P_LINK_TO_SPINE201_Ethernet1 | routed | - | 10.129.4.1/31 | default | 1500 | false | - | - |
| Ethernet18 | P2P_LINK_TO_SPINE202_Ethernet1 | routed | - | 10.129.4.3/31 | default | 1500 | false | - | - |
...
!
interface Ethernet1
   description VPC201_VPC201-nic0
   no shutdown
   switchport
...
interface Ethernet17
   description P2P_LINK_TO_SPINE201_Ethernet1
   no shutdown
   mtu 1500
   no switchport
...
interface Ethernet18
   description P2P_LINK_TO_SPINE202_Ethernet1
   no shutdown
   mtu 1500
   no switchport
   ip address 10.129.4.3/31
   ip ospf network point-to-point
   ip ospf area 0.0.0.0
!
interface Ethernet19
   description MLAG_PEER_LEAFA202_Ethernet19
   no shutdown
   channel-group 19 mode active
!
interface Ethernet20
   description MLAG_PEER_LEAFA202_Ethernet20
   no shutdown
   channel-group 19 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel19 | MLAG_PEER_LEAFA202_Po19 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel19
   description MLAG_PEER_LEAFA202_Po19
   no shutdown
   switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.129.0.1/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 10.129.1.1/32 |
| Loopback2 | VRF-NONPRO_VTEP_DIAGNOSTICS | VRF-NONPRO | 192.168.7.65/32 |
...
| Vlan3999 |  VRF-NONPRO  |  10.129.3.0/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  10.129.3.0/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  10.129.2.0/31  |  -  |  -  |  -  |  -  |  -  |
...
| ---------- | --------- | ------------------------- | -------------------- | --- | ------- | ----------------------------- | ---------------------------- | ----------------------------- | ------------- | --------------------- | ------------------ |
| 100 | 10.129.0.1 | enabled | Ethernet17 <br> Ethernet18 <br> Vlan4093 <br> | disabled | 12000 | disabled | disabled | - | - | - | - |
...
| -------------- | --------------------- |
| VRF-NONPRO | 192.168.7.65 |

## Virtual Source NAT Configuration

```eos
!
ip address virtual source-nat vrf VRF-NONPRO address 192.168.7.65
```
