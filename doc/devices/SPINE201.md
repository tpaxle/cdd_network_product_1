...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 10.0.0.111/24 | 10.0.0.1 |
...
!
interface Ethernet1
   description P2P_LINK_TO_LEAFA201_Ethernet17
   no shutdown
   mtu 1500
   no switchport
   ip address 10.129.4.0/31
   ip ospf network point-to-point
   ip ospf area 0.0.0.0
!
interface Ethernet2
   description P2P_LINK_TO_LEAFA202_Ethernet17
   no shutdown
   mtu 1500
   no switchport
   ip address 10.129.4.4/31
   ip ospf network point-to-point
   ip ospf area 0.0.0.0
!
interface Ethernet5
   ...
   mtu 1500
   no switchport
   ip address 10.129.4.56/31
   ip ospf network point-to-point
   ip ospf area 0.0.0.0
!
interface Ethernet6
   description P2P_LINK_TO_BLEAF202_Ethernet17
   no shutdown
   mtu 1500
   no switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.129.0.249/32 |
