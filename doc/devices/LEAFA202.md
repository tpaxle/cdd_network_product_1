...
| Loopback2 | VRF-NONPRO_VTEP_DIAGNOSTICS | VRF-NONPRO | 10.215.7.2/32 |
...
| -------------- | --------------------- |
| VRF-NONPRO | 10.215.7.2 |

## Virtual Source NAT Configuration

```eos
!
ip address virtual source-nat vrf VRF-NONPRO address 10.215.7.2
```
