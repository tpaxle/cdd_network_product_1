...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 10.0.0.33/24 | 10.0.0.1 |
...
| --------- | --------------- | ------------ | --------- |
| AZ1_CL3_4 | Vlan4094 | 10.128.2.5 | Port-Channel19 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 |  VPC1_VPC-nic0 | access | 17 | - | - | - |
| Ethernet19 | MLAG_PEER_LEAFB102_Ethernet19 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 19 |
| Ethernet20 | MLAG_PEER_LEAFB102_Ethernet20 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 19 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet17 | P2P_LINK_TO_SPINE101_Ethernet5 | routed | - | 10.128.4.9/31 | default | 1500 | false | - | - |
| Ethernet18 | P2P_LINK_TO_SPINE102_Ethernet5 | routed | - | 10.128.4.11/31 | default | 1500 | false | - | - |
...
interface Ethernet17
   description P2P_LINK_TO_SPINE101_Ethernet5
   no shutdown
   mtu 1500
   no switchport
   ip address 10.128.4.9/31
   ip ospf network point-to-point
   ip ospf area 0.0.0.0
!
interface Ethernet18
   description P2P_LINK_TO_SPINE102_Ethernet5
   no shutdown
   mtu 1500
   no switchport
   ip address 10.128.4.11/31
   ip ospf network point-to-point
   ip ospf area 0.0.0.0
!
interface Ethernet19
   description MLAG_PEER_LEAFB102_Ethernet19
   no shutdown
   channel-group 19 mode active
!
interface Ethernet20
   description MLAG_PEER_LEAFB102_Ethernet20
   no shutdown
   channel-group 19 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel19 | MLAG_PEER_LEAFB102_Po19 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel19
   description MLAG_PEER_LEAFB102_Po19
   no shutdown
   switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.128.0.3/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 10.128.1.3/32 |
| Loopback2 | VRF-NONPRO_VTEP_DIAGNOSTICS | VRF-NONPRO | 192.168.7.3/32 |
...
interface Loopback0
   ...
   no shutdown
   ip address 10.128.0.3/32
   ip ospf area 0.0.0.0
!
interface Loopback1
   description VTEP_VXLAN_Tunnel_Source
   no shutdown
   ip address 10.128.1.3/32
   ip ospf area 0.0.0.0
!
interface Loopback2
...
| Vlan3999 |  VRF-NONPRO  |  10.128.3.4/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  10.128.3.4/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  10.128.2.4/31  |  -  |  -  |  -  |  -  |  -  |
...
| ---------- | --------- | ------------------------- | -------------------- | --- | ------- | ----------------------------- | ---------------------------- | ----------------------------- | ------------- | --------------------- | ------------------ |
| 100 | 10.128.0.3 | enabled | Ethernet17 <br> Ethernet18 <br> Vlan4093 <br> | disabled | 12000 | disabled | disabled | - | - | - | - |
...
| -------------- | --------------------- |
| VRF-NONPRO | 192.168.7.3 |

## Virtual Source NAT Configuration

```eos
!
ip address virtual source-nat vrf VRF-NONPRO address 192.168.7.3
```
